...
# nixOS Config
{
  ...
  xdg = {
    portal = {
      ...
      extraPortals = with pkgs; [
        (writeShellScriptBin "sway-unsupported" ''
          exec ${sway}/bin/sway --unsupported-gpu "$@"
        '')
  ...
  environment = {
    ...
    systemPackages = with pkgs; [
      ...
      config.boot.kernelPackages.nvidia_x11 # This includes nvidia-smi
      cudatoolkit #needed for blender
